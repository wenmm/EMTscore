...
scores <- compute_Signature_score(geneExp, signature_file , row_name = "stemness_score")
head(scores)
```
```{r}
signature_file <- system.file("extdata", "cellular_senescence_sig.tsv", package = "EMTscore")
scores <- compute_Signature_score(geneExp, signature_file, row_name = "senescence_score")
head(scores)
```
