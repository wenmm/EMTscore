...
`Execute_nnPCA_parallel`: nnPCA is a nonnegative PCA based method <a href='#ref4'> (Panchy et al. 2021) </a>. It is preferred because of its high efficiency and the capacity of generating muliple scores for a gene set.<br>
`Execute_AUCell_parallel`: AUCell is a method based on area under the curve for gene ranks <a href='#ref5'> (Aibar et al. 2017) </a>.<br>
`Execute_ssGSEA_parallel`: ssGSEA is a widely used method based on Kolmogorov-Smirnov test <a href='#ref6'> (Barbie et al. 2009) </a>. <br>
`Execute_JASMINE_parallel`: JASMINE is a recently developed method based on gene ranks  <a href='#ref7'> (Noreen et al. 2022) </a>.<br>
`Execute_SCSE_parallel`: SCSE is another normalized sum-based method <a href='#ref8'> (Pont et al. 2019) </a>.<br>
